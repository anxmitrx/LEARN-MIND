      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6">
        <div className="max-w-3xl">
          ...
          <h2 className="mt-4 font-display text-5xl font-bold leading-[0.95] tracking-wide text-ink sm:text-6xl">
            The full <span className="bg-yellow px-2 rounded-lg">industry stack.</span>
          </h2>
        </div>
          ...
          {pillars.map((p, i) => {
            ...
            return (
              <motion.div
                ...
                className={`bento-card relative overflow-hidden p-8 rounded-3xl shadow-md shadow-[#3A3532]/5 ${bg}`}
              >
