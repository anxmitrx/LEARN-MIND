          ...
          >
            ...
            {mode === "initial" && (
              <div className="mt-8 flex flex-col gap-3">
                {loginError && (
                  <p className="text-xs font-bold text-red-600 mb-2 bg-red-50 p-2 rounded-lg border border-red-100">
                    {loginError}
                  </p>
                )}
            ...
            {mode === "email" && linkSent && (
              ...
              >
                ...
                <p className="text-xs text-indigo-700 leading-relaxed">
                  We sent a magic link to <span className="font-semibold">{email}</span>. Click the
                  link to securely verify your email and complete setup.
                </p>
                {linkError && <p className="text-xs font-bold text-red-600 mt-2">{linkError}</p>}
              </motion.div>
            )}
