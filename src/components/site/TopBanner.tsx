...
export function TopBanner() {
  ...
  return (
    <Link
      ref={bannerRef}
      to="/class-12-consult"
      className="group sticky top-0 z-50 flex min-h-10 w-full items-center justify-center border-b-2 border-ink bg-yellow px-4 py-2.5 text-center text-xs font-bold text-ink hover:underline md:text-sm"
    >
