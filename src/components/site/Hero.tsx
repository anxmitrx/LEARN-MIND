...
export function Hero() {
  ...
  return (
    <section className="relative overflow-hidden border-b-2 border-ink bg-background">
      ...
      <div className="pointer-events-none absolute -top-32 -right-24 h-[36rem] w-[36rem] rounded-full border-2 border-ink" />
      ...
      <div className="container relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:py-32">
        ...
        >
          <div>
            <motion.span
              variants={item}
              className="inline-flex items-center gap-2 border-2 border-ink bg-background px-3 py-1 text-xs font-display font-extrabold uppercase tracking-wider text-ink shadow-brutal-sm"
            >
            ...
            <motion.h1
              variants={item}
              className="mt-6 font-display text-[clamp(2.5rem,8vw,6.5rem)] font-black leading-[0.92] tracking-[-0.03em] text-ink"
            >
              Stop hoping <br />
              you'll figure <br />
              <span className="relative inline-block">
                <span className="absolute inset-x-0 bottom-2 -z-10 h-5 bg-yellow sm:h-7" />
                it out.
              </span>
            </motion.h1>
            ...
            <motion.div
              variants={item}
              className="mt-14 grid max-w-lg grid-cols-3 gap-6 border-t-2 border-ink pt-8"
            >
              {[
                ...
                <div key={s.v}>
                  <div className="font-display text-4xl font-black text-ink">{s.k}</div>
          ...
          >
            <div className="animate-float-slow relative border-2 border-ink bg-background p-6 shadow-brutal-lg">
              <div className="flex items-center justify-between">
                <span className="inline-flex items-center gap-1.5 border-2 border-ink bg-yellow px-2.5 py-1 text-xs font-extrabold uppercase tracking-wider text-ink">
            ...
            <div className="absolute -bottom-6 -left-8 border-2 border-ink bg-yellow p-4 shadow-brutal">
              <div className="eyebrow text-ink">Outcome</div>
              <div className="mt-1 font-display text-lg font-black text-ink">Hired at Infosys</div>
