    ...
    <main className="min-h-screen bg-transparent text-slate-800">
      ...
      <section className="relative overflow-hidden bg-transparent">
        ...
        <div className="container relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:py-24">
          <Link to="/tracks" className="inline-flex items-center gap-2 text-sm font-bold text-indigo-600 hover:underline focus-visible:ring-2 focus-visible:ring-indigo-600 focus-visible:outline-none rounded px-1">
          ...
          <div className="mt-8 grid items-center gap-12 lg:grid-cols-[1.15fr_0.85fr]">
            <div>
              ...
              <p className="mt-6 max-w-xl text-lg text-slate-600 font-semibold">{track.description}</p>
        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <div className="mt-12 grid gap-5 lg:grid-cols-3">
                ...
                {track.topics.map((tp, i) => (
                  ...
                  >
                    <span className="grid h-9 w-9 shrink-0 place-items-center bg-indigo-100 text-indigo-700 border border-indigo-200/50 rounded-full shadow-sm">
                      <tp.icon className="h-4 w-4 text-indigo-700" />
                    </span>
            ...
            <BentoCard tone="ink" className="lg:col-span-3">
              <div className="font-mono text-xs font-bold text-indigo-300">// C · SAMPLE AGENDA</div>
      ...
      <section className="bg-transparent py-20">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6">
          <div className="mb-10 flex items-end justify-between">
            ...
            <Link to="/tracks" className="text-sm font-extrabold text-indigo-600 underline underline-offset-4">View all →</Link>
          </div>
