    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="border-b border-white/5 py-24">
        <div className="container mx-auto max-w-4xl px-4 sm:px-6">
          <span className="eyebrow text-yellow">Our Mission</span>
          <h1 className="mt-4 font-display text-5xl font-extrabold tracking-tight text-white sm:text-6xl">
            We make students <span className="text-gradient-yellow">job-ready</span> — not just qualified.
          </h1>
