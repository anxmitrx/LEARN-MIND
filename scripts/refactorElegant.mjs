...
content = content.replace(/min-h-screen bg-\[#0B0F19\] text-slate-300 relative overflow-hidden/g, 'min-h-screen bg-[#FAFAFA] text-slate-800 dot-bg relative overflow-hidden');

// Gradients for Hero
content = content.replace(/from-\[#0B0F19\] via-\[#0B0F19\]\/80/g, 'from-[#FAFAFA] via-[#FAFAFA]/70');
content = content.replace(/sm:from-\[#0B0F19\]\/95 sm:via-\[#0B0F19\]\/80/g, 'sm:from-[#FAFAFA]/95 sm:via-[#FAFAFA]/70');
...
// Shadows
content = content.replace(/shadow-\[0_8px_32px_0_rgba\(0,0,0,0\.5\)\]/g, 'shadow-[0_8px_32px_0_rgba(31,38,135,0.07)]');
...
content = content.replace(/shadow-\[0_0_20px_rgba\(79,70,229,0\.3\)\]/g, 'shadow-lg shadow-indigo-500/30');
content = content.replace(/shadow-\[0_0_30px_rgba\(79,70,229,0\.5\)\]/g, 'shadow-xl shadow-indigo-500/40');
content = content.replace(/shadow-\[0_20px_50px_rgba\(79,70,229,0\.3\)\]/g, 'shadow-xl shadow-indigo-500/20');
content = content.replace(/shadow-\[0_20px_60px_rgba\(79,70,229,0\.4\)\]/g, 'shadow-2xl shadow-indigo-500/30');
