...
for (const file of files) {
  ...
  const highlightRegex1 =
    /<span className="bg-gradient-to-r from-indigo-500\/20 to-purple-500\/20[^"]*"><\/span>/g;
  ...
  const highlightRegex2 =
    /bg-gradient-to-r from-indigo-500\/20 to-purple-500\/20 px-[0-9] rounded-[a-z]+/g;
  ...
  const highlightRegex3 =
    /bg-gradient-to-r from-indigo-500\/20 to-purple-500\/20 box-decoration-slice px-[0-9] rounded-[a-z]+/g;
  ...
  if (file.endsWith("Hero.tsx")) {
    const heroRegex =
      /<span className="absolute inset-0 bg-gradient-to-r from-indigo-500\/20 to-purple-500\/20 blur-sm rounded-lg -z-10"><\/span>/g;
